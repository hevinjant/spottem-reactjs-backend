...
def test_update_current_track():
    song = Song(test_email, 'abc123', 'Test Song', 'Test Artist', 'Test Album', 'http://testurl.com', None)
...
def test_update_current_track2():
    song = Song(test_email, 'abc456', 'Test Song', 'Test Artist', 'Test Album', 'http://testurl.com', None)
    Database().update_current_track(converted_test_email, song)
    user = Database().get_user(converted_test_email)
...
def test_create_song_history():
    song_history = Song(test_email, 'abc123', 'Test Song', 'Test Artist', 'Test Album', 'http://testurl.com', None)
...
def test_create_reaction():
    song_history = Song(test_email, 'song123', 'Test Song', 'Test Artist', 'Test Album', 'http://testurl.com', None)
    Database().create_song_history(song_history)
    reaction = Reaction(converted_test_email, 'name', sender_email, 'sender name', 'song123', 'song name', 'song artists', 'song album', 'song url', 'song image url', 'time stamp')
